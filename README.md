   ![Alt text](https://www.totsy.com/skin/frontend/enterprise/harapartners/images/logoN.png "Totsy Logo")
--

## Notes

I am currently working on the PageObject project where I want to use existing Hybrid Framework with:

 * **BDD with JBehave and Selenium** 
 * **Frank** - Frank is 'Selenium for native iOS apps'
 * **Robotium** - It's like Selenium, but for Android
 * **iPhoneDriver** (For Funtional testing)  
 * **AndroidDriver** (For Funtional testing) 
 * **Selenium Grid 2** 
 * **Jenkins** 
 * **TestNG** 
 * **JUnit** - For Robotium only!!
 * **Maven** 
 * **Ant** 
 * **Robot Frameworks** 
